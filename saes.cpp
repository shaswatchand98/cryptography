...
class AES
{
    ...
    unordered_map<string, string> sbox {{"0000", "1001"}, {"0001", "0100"}, {"0010", "1010"}, {"0011", "1011"},
    {"0100", "1101"}, {"0101", "0001"}, {"0110", "1000"}, {"0111", "0101"}, {"1000", "0110"},
    {"1001", "0010"}, {"1010", "0000"}, {"1011", "0011"}, {"1100", "1100"}, {"1101", "1110"}, 
    {"1110", "1111"}, {"1111", "0111"} };
 
    unordered_map<string, string> rsbox {{"0000", "1010"}, {"0001", "0101"}, {"0010", "1001"}, {"0011", "1011"},
    ...
    */
    string reduce(string s)
    {
        ...
        for(int j=keylen;j<=datalen;j++)
        {
            ...
            if(j!=datalen)
                rem[keylen-1]=s[j];        //appending next bit of data to remainder obtain by division
            else
                rem[keylen-1]='\0';
        }
    ...
    void Decryption()
    {
        ...
        p = sub;
        sub="";
        cout<<"\nAfter Inverse Substitute nibble: "<<p;
